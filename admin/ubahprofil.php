...
if (isset($_POST["ubah"])) 
{
	...
	$koneksi->query("UPDATE toko SET namatoko='$nama', email='$email', telepon='$telepon', provinsi='$_POST[provinsi]', tipe='$tipe', distrik='$distrik', alamat='$alamat', fotoprofil='$fototoko'");
