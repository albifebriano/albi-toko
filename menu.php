...
<nav>
  <ul>
    ...
    <?php else : ?>
      <li class="items"><a href="login.php"><i class="fas fa-users"></i> Login</a></li>
      <li class="items"><a href="daftar.php"><i class="fa-solid fa-user-plus"></i>Daftar</a></li>
    <?php endif ?>
